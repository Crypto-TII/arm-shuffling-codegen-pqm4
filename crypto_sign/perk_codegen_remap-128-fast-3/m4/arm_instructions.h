...
// Section A.7.7.46 (LDRB (immediate)), encoding T2
#define LDRB(RT, RN, IMM) ((0x0000f890) | ((RT) << 28) | (RN) | ((IMM) << 16))

// Section A.7.7.77 (MOV (register)), encoding T3
#define MOV_REG(RD, RM) (0x0000ea4f | ((RD) << 24) | ((RM) << 16))
